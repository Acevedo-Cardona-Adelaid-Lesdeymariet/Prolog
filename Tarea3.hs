...
------------------------------------------------------------
------------------- FUNCIONES DE TAREA 3 -------------------
------------------------------------------------------------


-- Funcion para Añadir un Elemento a nuestra Lista.


agregar :: Grupos -> Grupo -> Grupos
agregar lista n = n:lista

 -- PARA EJECUTAR EN CONSOLA: agregar lista1 ("Homeshake",[("In the Shower",2014,10,"29:45 min"), ("Midnight Snack",2015,12,"33:14 min"), ("Fresh Air",2017,14,"43:13 min"),("Helium",2019,13,"33:11 min")],2012, "Hypnagogic Pop", [("Peter Sagar", "Guitarra" , 29, 2012, True)],"Ningun Tour Actual",[])



-- Funcion para Concatenar nuestra Lista de 10 Bandas con una Lista de 2 Bandas mas.


concatenarListas :: Grupos -> Grupos -> Grupos
concatenarListas lista1 lista2 = lista1 ++ lista2

 -- PARA EJECUTAR EN CONSOLA: concatenarListas lista1 lista2



-- Funcion que nos regrese el primer album de la banda "solicitada" utilizando el "operador" head.


primerAlbum :: Grupos -> NombreGrupo -> Albumes
primerAlbum lista n =  head [[(nombrealbum, año, nocanciones, duracion)] | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombrealbum, año, nocanciones, duracion) <- albumes,nombregrupo == n]

 -- PARA EJECUTAR EN CONSOLA: primerAlbum lista1 "Stuck in the Sound"



-- Funcion que nos regrese el numero de elementos dentro de la lista de albums, utilizando el operador "length"


numeroElementos :: Grupos -> NombreGrupo -> Int
numeroElementos lista n = length [[(nombrealbum, año, nocanciones, duracion)] | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombrealbum, año, nocanciones, duracion) <- albumes, nombregrupo == n]

 -- PARA EJECUTAR EN CONSOLA: numeroElementos lista1 "Stuck in the Sound"




------------------------------------------------------------
------------------- FUNCIONES DE TAREA 2 -------------------
------------------------------------------------------------



-- Funcion que retorna todos los Atributos de un Grupo Musical en Concreto
...
fia1 lista = [(nombreintegrante, instrumento, edad, añoingreso, status) | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, status == True]

fia2 :: Grupos -> [NombreIntegrante]
fia2 lista = [nombreintegrante | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, status == True]
...
fb1 lista = [(nombreintegrante, instrumento, edad, añoingreso, status) | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, instrumento == "Bateria"]

fb2 :: Grupos -> [NombreIntegrante]
fb2 lista = [nombreintegrante | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, instrumento == "Bateria"]
...
fgi1 lista = [(nombreintegrante, instrumento, edad, añoingreso, status) | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, instrumento == "Guitarra" && status == False]

fgi2 :: Grupos -> [NombreIntegrante]
fgi2 lista = [nombreintegrante | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, instrumento == "Guitarra" && status == False] 

-- Funcion de Integrantes Posteriores al año 2000

fip1 :: Grupos -> Integrantes
fip1 lista = [(nombreintegrante, instrumento, edad, añoingreso, status) | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, añoingreso > 2000]

fip2 :: Grupos -> [NombreIntegrante]
fip2 lista = [nombreintegrante | (nombregrupo, albumes, añodebut, genero, integrantes, touractual, ciudadesdeltour) <- lista, (nombreintegrante, instrumento, edad, añoingreso, status) <- integrantes, añoingreso > 2000]
